...
## Описание
Скрипт ___gendata.py___ <prob> относит каждый файл исходной выборки к тренировочной с вероятностью prob, а к тестовой - с вероятностью 1. - prob. Таким образом, данные делятся примерно в таком отношении: тренировочная / тестовая = prob / (1. - prob) 
