...
## Обновления
23.10.16 - с помощью **make all** теперь можно выполнять тестирование на выданных тестовых данных (без генерации), прошлая версия **make all** теперь называется **make cross**
